...
\title{Model-Checking Fault-Tolerant Distributed System Implementations}
\author{Ben and Lee}
...
\begin{abstract}
We present a modeling framework for fault-tolerant distributed system verification.
\end{abstract}
...
There is a long history of formally verifying fault-tolerant distributed systems. Most previous work has used mechanical theorem-proving, given the complexity of these systems and models. OM(1) is a particularly good case-study that has a history of verification. Most
